    ...
    <div class="card-body bg-info">
        ...
        <div class="card">
            <div class="card-body" style="color: black">
                ...
                <div class="row" class="col-12">
                    <div class="form-group row col-6">
                        <label for="" class="col-sm-4 col-form-label"><button type="button" class="btn btn-info btn-sm"
                                data-toggle="modal" data-target="#modalMember"><i
                                    class="bi bi-plus-square"></i></button> Nama Pelanggan</label>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <button type="button" class="btn btn-info btn-sm" id="tambahPaketBtn" data-toggle="modal"
                            data-target="#modalPaket"><i class="bi bi-plus-square"></i> Tambah Cucian</button>
                    </div>
                </div>
                        ...
                        <tfoot>
                            <tr valign="bottom">
                                ...
                                <td rowspan="5">
                                    ...
                                    <input type="text" class="form-control" name="bayar" id="" value="0"
                                        style="width:170px">
                                    <div class="">
                            ...
                            <tr>
                                <td colspan="3" align="right">Pajak <input type="number" name="pajak"
                                        class="qty" min="0" value="0" id="pajak-persen" size="2"
                                        style="width: 40px"></td>
...
{{-- modal member --}}
<div class="modal fade z-10" id="modalMember" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
