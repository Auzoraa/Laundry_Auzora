...
<div class="card">
  <div class="card-header d-flex">
    ...
    <button type="button" id="btn-export-xls" class="d-flex btn btn-success mr-1"><i class="fas fa-download"></i> Xls</button>
    <button type="button" class="d-flex btn btn-danger"><i class="fas fa-download"></i> Pdf</button>
    <button type="button" class="btn btn-success ml-auto" data-toggle="modal" data-target="#importExcel">
      <i class="fas fa-file-excel"></i> Import Xls</button>
</div>
  <div class="card-body">
